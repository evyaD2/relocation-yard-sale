  ...
  return (
    <div className="min-h-screen bg-oatmeal text-jet font-sans antialiased relative z-0">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        {/* Top organic shape */}
        <svg className="absolute -top-[10%] -left-[10%] w-[500px] h-[500px] text-[#D4940A] opacity-25 animate-[spin_60s_linear_infinite]" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="absolute top-[30%] -right-[5%] w-[400px] h-[400px] text-[#2E7D6E] opacity-15" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.div
        className="fixed top-0 left-0 right-0 h-1.5 bg-[#C0392B] origin-left z-50 shadow-sm border-b border-jet"
